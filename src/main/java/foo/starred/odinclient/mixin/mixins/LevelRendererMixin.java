...
public class LevelRendererMixin {
    ...
    private VoxelShape odinClient$extractBlockOutline(BlockState instance, BlockGetter level, BlockPos pos, CollisionContext context, Operation<VoxelShape> original) {
