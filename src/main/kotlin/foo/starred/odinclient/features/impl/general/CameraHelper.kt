...
object CameraHelper : Module(
    ...
    val enableDist by BooleanSetting(
        "Custom distance",
        false,
        desc = "Allows you to set a custom distance for the camera."
    )
    val cameraDist by NumberSetting(
        "Distance",
        4f,
        3.0,
        12.0,
        0.1,
        desc = "The distance of the camera from the player."
    ).withDependency { enableDist }
}